...
public class ConnectButton extends ButtonObject {

	@Override
	public void onInit() {
		// TODO Auto-generated method stub
		this.setVisible(false);
		this.setTexturePath("menu/buttons/connect.png");
	...
	public void onLeftClickReleased() {
		...
		if(!((MenuScene) getScene()).isMenuSwitched())
			((Quarto) this.getScene().getGameEngine()).onLaunchGame(Difficulties.ONLINE, DataManager.reloadDataFile("online").get("HOST"));
	}
