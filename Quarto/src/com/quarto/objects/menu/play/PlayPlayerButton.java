...
public class PlayPlayerButton extends ButtonObject{
	
	@Override
	public void onInit() {
		// TODO Auto-generated method stub
		this.setVisible(false);
		this.setTexturePath("menu/buttons/play_vs.png");
	...
	public void onLeftClickReleased() {
		...
		if(!((MenuScene) getScene()).isMenuSwitched())
			((Quarto) this.getScene().getGameEngine()).onLaunchGame(Difficulties.PVP, null);
	}
