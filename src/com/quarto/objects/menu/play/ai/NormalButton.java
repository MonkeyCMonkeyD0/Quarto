...
public class NormalButton extends ButtonObject {

	@Override	
	public void onInit() {
		// TODO Auto-generated method stub
		this.setVisible(false);
		this.setTexturePath("menu/buttons/normal.png");
	...
	public void onLeftClickReleased() {
		...
		if(!((MenuScene) getScene()).isMenuSwitched())
			((Quarto) this.getScene().getGameEngine()).onLaunchGame(Difficulties.NORMAL, null);
	}
